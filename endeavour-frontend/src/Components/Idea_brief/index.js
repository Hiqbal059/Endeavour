                ...
                <Container style={{ padding: '30px', borderBottom: '1px solid rgba(141, 141, 141, 1)' }}>
                  ...
                  <Row>
                      <Col md={12}>
                          <Row>
                              <Col md={12}>
                                  <h1 style={{ padding: '50px 0px', fontSize: '20px', color: 'rgba(0, 0, 0, 1)' }}> What people loved about this Idea </h1>
                              </Col>
                          </Row>
                          <Row >
                              <Col md={10} style={{ border: '1px solid rgba(151, 151, 151, 1)', padding: '30px 5px' }}>
                                  <Row>
                                      <Col md={2} className='m-auto'>
                                          <img src={idea} alt="Idea" className='d-block' style={{ paddingLeft: '30px' }} />
                                      </Col>
                                      <Col md={10}>
