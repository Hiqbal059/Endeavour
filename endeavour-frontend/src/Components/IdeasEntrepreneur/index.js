...
const pages = ['Dashboard', 'Messages', 'Pitch Idea'];
                ...
                <Container style={{ background: '#fff', marginTop: '30px',  }}>
                   ...
                   <Row style={{ paddingTop: '20px' }}>
                    ...
                    <Row style={{ paddingTop: '18px' }}>
                        <Col md={6}>
                            <Row style={{ borderBottom: '1px solid gray', padding: '5px 0px' }}>
                                <Col md={4}>
                                    <img src={car} alt="Car Image" />
                                </Col>
                                <Col md={8}>
                                    <h1 style={{ fontSize: '20px', paddingTop: '40px' }}> OneTransport </h1>
                                </Col>
                            </Row>
                        </Col>
                        <Col md={6}>
                        <Row style={{ padding: '12px 0px',borderBottom: '1px solid gray' }}>
                                <Col md={4}>
                                    <p style={{ paddingTop: '40px' }}> 665 </p>
                                </Col>
                                <Col md={4}>
                                    <p style={{ paddingTop: '40px' }}>997</p>
                                </Col>
                                <Col md={4}>
                                    <p style={{ color: '#2A61F5', cursor: 'pointer',paddingTop: '40px' }}> View </p>
                                </Col>
                            </Row>
                        </Col>
                    </Row>
